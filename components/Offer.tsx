...
const Offer: React.FC = () => (
  <section style={{ padding: '100px 0' }}>
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 2rem' }}>
      <div style={{ background: '#0F1218', border: '1px solid rgba(255,255,255,0.063)', borderRadius: 18, padding: '64px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: '4rem', alignItems: 'center', position: 'relative' as const, overflow: 'hidden' }}>
        <div>
