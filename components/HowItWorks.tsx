...
const steps = [
  {n:'01',title:'We Find You',desc:'Our AI scans Google Maps and local directories, then audits your existing website — scoring it on design, speed, mobile readiness, and trust signals.',tag:'AI-Powered Scan'},
  {n:'02',title:'We Build First',desc:'Before we ever contact you, we have already designed your replacement. You see the finished website — not a concept, not a mockup. The real, working thing.',tag:'Done Before You Ask'},
  {n:'03',title:'You Decide',desc:'We send you the link by email and text. $99 to claim it. Love it or walk away — no pressure, no sales call, no invoice until you say yes.',tag:'Zero Commitment'},
  {n:'04',title:'We Launch',desc:'We handle the install, domain connection, and go-live on your existing host — or set up hosting for you. Your business is upgraded with zero effort on your end.',tag:'Full White-Glove'},
];
