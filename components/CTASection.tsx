  ...
  return (
    <div id="cta" style={{ background: '#F07A20', padding: '90px 2rem', textAlign: 'center' as const }}>
      ...
      <div style={{ display: 'flex', maxWidth: 500, margin: '0 auto', borderRadius: 8, overflow: 'hidden', border: '2px solid rgba(255,255,255,0.25)' }}>
        <input type="text" value={val} onChange={e => setVal(e.target.value)} placeholder="Business name or website URL..." style={{ flex: 1, padding: '16px 20px', border: 'none', fontFamily: 'DM Sans,sans-serif', fontSize: 15, background: 'rgba(255,255,255,0.12)', color: '#fff', outline: 'none' }} />
